    ...
    <section class="col-span-12 lg:col-start-2 lg:col-span-6">
        <form @submit.prevent="submitForm" class="col-span-6 lg:col-span-3 mb-7">
          <div class="col-span-6 lg:col-span-3 mb-7">
            ...
            <input class="text-sm lg:text-base text-Background w-full mt-1.5 h-11 lg:h-14 rounded-2xl border-Violet border-4 px-4 focus:border-Rose focus:outline-none invalid:border-[#ce0000]" type="text" name="firstName" v-model="form.firstName" placeholder="Mattieu"/>
          </div>
          <div class="col-span-6 lg:col-span-3 mb-7">
            <label class="font-michroma text-base lg:text-xl" for="lastName">Nom*</label>
            <input class="text-sm lg:text-base text-Background w-full mt-1.5 h-11 lg:h-14 rounded-2xl border-Violet border-4 px-4 focus:border-Rose focus:outline-none invalid:border-[#ce0000]" type="text" name="lastName" v-model="form.lastName" placeholder="Petit-Jean"/>
          </div>
          <div class="col-span-6 lg:col-span-3 mb-7">
            <label class="font-michroma text-base lg:text-xl" for="email">Email*</label>
            <input class="text-sm lg:text-base text-Background w-full mt-1.5 h-11 lg:h-14 rounded-2xl border-Violet border-4 px-4 focus:border-Rose focus:outline-none invalid:border-[#ce0000]" type="email" name="email" v-model="form.email" placeholder="PJ.Mattieu@gmail.com"/>
          </div>
          <div class="col-span-6 lg:col-span-3 mb-7">
            <label class="font-michroma text-base lg:text-xl" for="object">Objet*</label>
            <input class="text-sm lg:text-base text-Background w-full mt-1.5 h-11 lg:h-14 rounded-2xl border-Violet border-4 px-4 focus:border-Rose focus:outline-none invalid:border-[#ce0000]" type="text" name="object" v-model="form.object" placeholder="Avis sur votre portfolio"/>
          </div>
          <div class="col-span-12 lg:col-span-6 mb-7">
            <label class="font-michroma text-base lg:text-xl" for="message">Message*</label>
            <textarea class="text-sm lg:text-base text-Background w-full mt-1.5 rounded-2xl border-Violet border-4 px-4 py-3 focus:border-Rose focus:outline-none invalid:border-[#ce0000]" rows="5" name="message" v-model="form.message" 
