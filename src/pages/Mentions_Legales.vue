<template>
    <div class="grille">
        ...
        <ul class="col-start-2 col-span-10 pt-6">
            ...
            <li class="mb-12">
                <h2 class="mb-5 font-michroma text-2xl">2. Propriété intellectuelle</h2>
            ...
            <li class="mb-12">
                <h2 class="mb-5 font-michroma text-2xl">3. Données personnelles</h2>
            ...
            <li class="mb-12">
                <h2 class="mb-5 font-michroma text-2xl">4. Cookies</h2>
                <p class="">Ce site peut utiliser des cookies pour améliorer l’expérience utilisateur. En continuant à naviguer sur le site, vous acceptez l’utilisation des cookies. Vous avez la possibilité de désactiver les cookies en modifiant les paramètres de votre navigateur.</p>
            </li>

            <li class="mb-12">
                <h2 class="mb-5 font-michroma text-2xl">5. Hébergeur du site</h2>
            ...
            <li class="mb-12">
                <h2 class="mb-5 font-michroma text-2xl">6. Contact</h2>
                <p class="">Pour toute question concernant les mentions légales ou l’utilisation de ce site, vous pouvez me contacter à l’adresse suivante : Bardey.lucas1@gmail.com</p>
            </li>
        </ul>
    </div>
</template>