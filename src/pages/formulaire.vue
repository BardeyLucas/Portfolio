...
<template>
    <article class="grille">
        <h1 class="col-span-12 pb-12 font-michroma text-6xl">Formulaire de contact</h1>
        <section class="col-span-12 lg:col-start-2 lg:col-span-6">
            <form class="col12 lg:col6">
                ...
                <div class="col-span-12 flex justify-around lg:col-span-6 lg:col6 text-Blanc mb-6 font-michroma text-xl">
                    <button class="px-5 lg:px-0 text-center lg:col-span-2 lg:col-start-2 bg-Violet h-12 rounded-xl"><input type="submit" value="Envoyer le mail" class="cursor-pointer"></button>
